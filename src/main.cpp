...
BOOL CALLBACK EnumAllWindowsProc(HWND hwnd, LPARAM lParam) {
  ...
  blog(LOG_INFO, "Window: '%s' [Class: %s] [PID: %d]%s%s", 
       title, className, processId, parentInfo, toolWindow);
...
Napi::Value EnumAllWindows(const Napi::CallbackInfo& info) {
...
Napi::Value EnumAllWindowsVerbose(const Napi::CallbackInfo& info) {
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  exports.Set("EnumAllWindows", Napi::Function::New(env, EnumAllWindows));
  exports.Set("EnumAllWindowsVerbose", Napi::Function::New(env, EnumAllWindowsVerbose));
